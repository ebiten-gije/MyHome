...
import himedia.myhome.dao.GuestbookDaoOI;
import himedia.myhome.dao.GuestbookVo;
...
public class GuestbookServlet extends BaseServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if("deleteform".equals(actionName)) {
			...
			RequestDispatcher rd = getServletContext().getRequestDispatcher("/WEB-INF/views/guestbook.jsp");
			rd.forward(req, resp);
		}
